...
void centroidOfImageObjects(IplImage *,CvPoint *,CvPoint *,CvPoint *,CvPoint *,CvPoint *,CvPoint *,CvPoint *,CvPoint *,CvPoint *);
int distancePoints(CvPoint ,CvPoint );
int template_matching1(IplImage *,IplImage *,CvPoint *);
int ycbcr_segment(IplImage *, IplImage *,int,int,int,int,int,int);
#endif
