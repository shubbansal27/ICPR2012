...
int main(int argc,char *argv[])
{
	...
	char arr[6];
	float dat[88];
	int randomLb[9] = {1,2,3,4,5,6,7,8,9};
	...
	while(fscanf(fp7,"%f",&dat[46]) == 1)
	{
		...
		fscanf(fp13,"%f",&dat[67]); //unwanted ftr
		...
		fscanf(fp14,"%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f",&dat[68],&dat[69],&dat[70],&dat[71],&dat[72],&dat[73],&dat[74],&dat[75],&dat[76],&dat[77],&dat[78],&dat[79],&dat[80],&dat[81],&dat[82],&dat[83],&dat[84],&dat[85],&dat[86],&dat[87]); //59 62
